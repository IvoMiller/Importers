-- <Migration ID="c2c6ded7-69e7-43a6-8421-1280c467da80" TransactionHandling="Custom"/>
GO

PRINT N'Creating role External Sales'
GO
CREATE ROLE [External Sales]
AUTHORIZATION [dbo]
GO
PRINT N'Creating role Far West Sales'
GO
CREATE ROLE [Far West Sales]
AUTHORIZATION [dbo]
GO
PRINT N'Creating role Great Lakes Sales'
GO
CREATE ROLE [Great Lakes Sales]
AUTHORIZATION [dbo]
GO
PRINT N'Creating role Mideast Sales'
GO
CREATE ROLE [Mideast Sales]
AUTHORIZATION [dbo]
GO
PRINT N'Creating role New England Sales'
GO
CREATE ROLE [New England Sales]
AUTHORIZATION [dbo]
GO
PRINT N'Creating role Plains Sales'
GO
CREATE ROLE [Plains Sales]
AUTHORIZATION [dbo]
GO
PRINT N'Creating role Rocky Mountain Sales'
GO
CREATE ROLE [Rocky Mountain Sales]
AUTHORIZATION [dbo]
GO
PRINT N'Creating role Southeast Sales'
GO
CREATE ROLE [Southeast Sales]
AUTHORIZATION [dbo]
GO
PRINT N'Creating role Southwest Sales'
GO
...
GO
PRINT N'Creating primary key [PK_Sales_Invoices] on [Sales].[Invoices]'
GO
ALTER TABLE [Sales].[Invoices] ADD CONSTRAINT [PK_Sales_Invoices] PRIMARY KEY CLUSTERED  ([InvoiceID])
GO
PRINT N'Creating index [FK_Sales_Invoices_AccountsPersonID] on [Sales].[Invoices]'
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Invoices_AccountsPersonID] ON [Sales].[Invoices] ([AccountsPersonID])
GO
PRINT N'Creating index [FK_Sales_Invoices_BillToCustomerID] on [Sales].[Invoices]'
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Invoices_BillToCustomerID] ON [Sales].[Invoices] ([BillToCustomerID])
GO
PRINT N'Creating index [IX_Sales_Invoices_ConfirmedDeliveryTime] on [Sales].[Invoices]'
GO
...
GO
PRINT N'Creating index [FK_Purchasing_Suppliers_AlternateContactPersonID] on [Purchasing].[Suppliers]'
GO
...
GO
PRINT N'Creating index [IX_Application_People_FullName] on [Application].[People]'
GO
CREATE NONCLUSTERED INDEX [IX_Application_People_FullName] ON [Application].[People] ([FullName])
GO
PRINT N'Creating index [IX_Application_People_IsEmployee] on [Application].[People]'
GO
CREATE NONCLUSTERED INDEX [IX_Application_People_IsEmployee] ON [Application].[People] ([IsEmployee])
GO
PRINT N'Creating index [IX_Application_People_Perf_20160301_05] on [Application].[People]'
GO
...
GO
PRINT N'Creating index [IX_Application_People_IsSalesperson] on [Application].[People]'
GO
...
GO
PRINT N'Creating index [FK_Sales_Customers_PostalCityID] on [Sales].[Customers]'
GO
CREATE NONCLUSTERED INDEX [FK_Sales_Customers_PostalCityID] ON [Sales].[Customers] ([PostalCityID])
GO
PRINT N'Creating index [FK_Sales_Customers_PrimaryContactPersonID] on [Sales].[Customers]'
GO
...
GO
PRINT N'Creating index [FK_Application_Cities_StateProvinceID] on [Application].[Cities]'
GO
...
GO
PRINT N'Creating index [FK_Application_StateProvinces_CountryID] on [Application].[StateProvinces]'
GO
CREATE NONCLUSTERED INDEX [FK_Application_StateProvinces_CountryID] ON [Application].[StateProvinces] ([CountryID])
GO
PRINT N'Creating index [IX_Application_StateProvinces_SalesTerritory] on [Application].[StateProvinces]'
GO
CREATE NONCLUSTERED INDEX [IX_Application_StateProvinces_SalesTerritory] ON [Application].[StateProvinces] ([SalesTerritory])
GO
PRINT N'Adding constraints to [Application].[StateProvinces]'
GO
...
GO
PRINT N'Creating primary key [PK_Warehouse_StockItemStockGroups] on [Warehouse].[StockItemStockGroups]'
GO
...
GO
PRINT N'Adding constraints to [Warehouse].[StockItemStockGroups]'
GO
...
GO
PRINT N'Adding constraints to [Application].[TransactionTypes]'
GO
...
GO
PRINT N'Creating index [CCX_Warehouse_StockItemTransactions] on [Warehouse].[StockItemTransactions]'
GO
CREATE CLUSTERED COLUMNSTORE INDEX [CCX_Warehouse_StockItemTransactions] ON [Warehouse].[StockItemTransactions]
GO
PRINT N'Creating primary key [PK_Warehouse_StockItemTransactions] on [Warehouse].[StockItemTransactions]'
GO
...
GO
PRINT N'Creating index [FK_Warehouse_StockItemTransactions_CustomerID] on [Warehouse].[StockItemTransactions]'
GO
CREATE NONCLUSTERED INDEX [FK_Warehouse_StockItemTransactions_CustomerID] ON [Warehouse].[StockItemTransactions] ([CustomerID])
GO
PRINT N'Creating index [FK_Warehouse_StockItemTransactions_InvoiceID] on [Warehouse].[StockItemTransactions]'
GO
CREATE NONCLUSTERED INDEX [FK_Warehouse_StockItemTransactions_InvoiceID] ON [Warehouse].[StockItemTransactions] ([InvoiceID])
GO
PRINT N'Creating index [FK_Warehouse_StockItemTransactions_PurchaseOrderID] on [Warehouse].[StockItemTransactions]'
GO
...
GO
PRINT N'Creating index [FK_Warehouse_StockItemTransactions_StockItemID] on [Warehouse].[StockItemTransactions]'
GO
CREATE NONCLUSTERED INDEX [FK_Warehouse_StockItemTransactions_StockItemID] ON [Warehouse].[StockItemTransactions] ([StockItemID])
GO
PRINT N'Creating index [FK_Warehouse_StockItemTransactions_SupplierID] on [Warehouse].[StockItemTransactions]'
GO
CREATE NONCLUSTERED INDEX [FK_Warehouse_StockItemTransactions_SupplierID] ON [Warehouse].[StockItemTransactions] ([SupplierID])
GO
PRINT N'Creating index [FK_Warehouse_StockItemTransactions_TransactionTypeID] on [Warehouse].[StockItemTransactions]'
GO
...
GO
PRINT N'Creating primary key [PK_Warehouse_StockItemHoldings] on [Warehouse].[StockItemHoldings]'
GO
...
GO
PRINT N'Creating primary key [PK_Sales_OrderLines] on [Sales].[OrderLines]'
GO
ALTER TABLE [Sales].[OrderLines] ADD CONSTRAINT [PK_Sales_OrderLines] PRIMARY KEY CLUSTERED  ([OrderLineID])
GO
PRINT N'Creating index [NCCX_Sales_OrderLines] on [Sales].[OrderLines]'
GO
...
GO
PRINT N'Creating index [FK_Sales_OrderLines_OrderID] on [Sales].[OrderLines]'
GO
CREATE NONCLUSTERED INDEX [FK_Sales_OrderLines_OrderID] ON [Sales].[OrderLines] ([OrderID])
GO
PRINT N'Creating index [FK_Sales_OrderLines_PackageTypeID] on [Sales].[OrderLines]'
GO
CREATE NONCLUSTERED INDEX [FK_Sales_OrderLines_PackageTypeID] ON [Sales].[OrderLines] ([PackageTypeID])
GO
PRINT N'Creating index [IX_Sales_OrderLines_Perf_20160301_01] on [Sales].[OrderLines]'
GO
...
GO
PRINT N'Creating index [IX_Sales_OrderLines_AllocatedStockItems] on [Sales].[OrderLines]'
GO
CREATE NONCLUSTERED INDEX [IX_Sales_OrderLines_AllocatedStockItems] ON [Sales].[OrderLines] ([StockItemID]) INCLUDE ([PickedQuantity])
GO
PRINT N'Creating index [IX_Sales_OrderLines_Perf_20160301_02] on [Sales].[OrderLines]'
GO
...
GO
PRINT N'Creating primary key [PK_Sales_InvoiceLines] on [Sales].[InvoiceLines]'
GO
ALTER TABLE [Sales].[InvoiceLines] ADD CONSTRAINT [PK_Sales_InvoiceLines] PRIMARY KEY CLUSTERED  ([InvoiceLineID])
GO
PRINT N'Creating index [NCCX_Sales_InvoiceLines] on [Sales].[InvoiceLines]'
GO
...
GO
PRINT N'Creating index [FK_Sales_InvoiceLines_InvoiceID] on [Sales].[InvoiceLines]'
GO
CREATE NONCLUSTERED INDEX [FK_Sales_InvoiceLines_InvoiceID] ON [Sales].[InvoiceLines] ([InvoiceID])
GO
PRINT N'Creating index [FK_Sales_InvoiceLines_PackageTypeID] on [Sales].[InvoiceLines]'
GO
CREATE NONCLUSTERED INDEX [FK_Sales_InvoiceLines_PackageTypeID] ON [Sales].[InvoiceLines] ([PackageTypeID])
GO
PRINT N'Creating index [FK_Sales_InvoiceLines_StockItemID] on [Sales].[InvoiceLines]'
GO
...
GO
PRINT N'Creating index [CX_Sales_CustomerTransactions] on [Sales].[CustomerTransactions]'
GO
CREATE CLUSTERED INDEX [CX_Sales_CustomerTransactions] ON [Sales].[CustomerTransactions] ([TransactionDate])
GO
PRINT N'Creating primary key [PK_Sales_CustomerTransactions] on [Sales].[CustomerTransactions]'
GO
...
GO
PRINT N'Creating index [FK_Sales_CustomerTransactions_CustomerID] on [Sales].[CustomerTransactions]'
GO
CREATE NONCLUSTERED INDEX [FK_Sales_CustomerTransactions_CustomerID] ON [Sales].[CustomerTransactions] ([CustomerID])
GO
PRINT N'Creating index [FK_Sales_CustomerTransactions_InvoiceID] on [Sales].[CustomerTransactions]'
GO
CREATE NONCLUSTERED INDEX [FK_Sales_CustomerTransactions_InvoiceID] ON [Sales].[CustomerTransactions] ([InvoiceID])
GO
PRINT N'Creating index [IX_Sales_CustomerTransactions_IsFinalized] on [Sales].[CustomerTransactions]'
GO
CREATE NONCLUSTERED INDEX [IX_Sales_CustomerTransactions_IsFinalized] ON [Sales].[CustomerTransactions] ([IsFinalized])
GO
PRINT N'Creating index [FK_Sales_CustomerTransactions_PaymentMethodID] on [Sales].[CustomerTransactions]'
GO
CREATE NONCLUSTERED INDEX [FK_Sales_CustomerTransactions_PaymentMethodID] ON [Sales].[CustomerTransactions] ([PaymentMethodID])
GO
PRINT N'Creating index [FK_Sales_CustomerTransactions_TransactionTypeID] on [Sales].[CustomerTransactions]'
GO
...
GO
PRINT N'Adding constraints to [Purchasing].[SupplierCategories]'
GO
...
GO
PRINT N'Adding constraints to [Application].[DeliveryMethods]'
GO
...
GO
PRINT N'Adding constraints to [Sales].[CustomerCategories]'
GO
...
GO
PRINT N'Adding constraints to [Sales].[BuyingGroups]'
GO
...
GO
PRINT N'Adding constraints to [Application].[Countries]'
GO
...
GO
PRINT N'Adding constraints to [Application].[PaymentMethods]'
GO
...
GO
PRINT N'Adding constraints to [Warehouse].[PackageTypes]'
GO
...
GO
PRINT N'Adding constraints to [Warehouse].[Colors]'
GO
...
GO
PRINT N'Creating primary key [PK_Purchasing_PurchaseOrders] on [Purchasing].[PurchaseOrders]'
GO
ALTER TABLE [Purchasing].[PurchaseOrders] ADD CONSTRAINT [PK_Purchasing_PurchaseOrders] PRIMARY KEY CLUSTERED  ([PurchaseOrderID])
GO
PRINT N'Creating index [FK_Purchasing_PurchaseOrders_ContactPersonID] on [Purchasing].[PurchaseOrders]'
GO
CREATE NONCLUSTERED INDEX [FK_Purchasing_PurchaseOrders_ContactPersonID] ON [Purchasing].[PurchaseOrders] ([ContactPersonID])
GO
PRINT N'Creating index [FK_Purchasing_PurchaseOrders_DeliveryMethodID] on [Purchasing].[PurchaseOrders]'
GO
CREATE NONCLUSTERED INDEX [FK_Purchasing_PurchaseOrders_DeliveryMethodID] ON [Purchasing].[PurchaseOrders] ([DeliveryMethodID])
GO
PRINT N'Creating index [FK_Purchasing_PurchaseOrders_SupplierID] on [Purchasing].[PurchaseOrders]'
GO
...
GO
PRINT N'Creating primary key [PK_Purchasing_PurchaseOrderLines] on [Purchasing].[PurchaseOrderLines]'
GO
...
GO
PRINT N'Creating index [IX_Purchasing_PurchaseOrderLines_Perf_20160301_4] on [Purchasing].[PurchaseOrderLines]'
GO
...
GO
PRINT N'Creating index [FK_Purchasing_PurchaseOrderLines_PackageTypeID] on [Purchasing].[PurchaseOrderLines]'
GO
CREATE NONCLUSTERED INDEX [FK_Purchasing_PurchaseOrderLines_PackageTypeID] ON [Purchasing].[PurchaseOrderLines] ([PackageTypeID])
GO
PRINT N'Creating index [FK_Purchasing_PurchaseOrderLines_PurchaseOrderID] on [Purchasing].[PurchaseOrderLines]'
GO
...
GO
PRINT N'Creating index [FK_Purchasing_PurchaseOrderLines_StockItemID] on [Purchasing].[PurchaseOrderLines]'
GO
...
GO
PRINT N'Creating index [CX_Purchasing_SupplierTransactions] on [Purchasing].[SupplierTransactions]'
GO
CREATE CLUSTERED INDEX [CX_Purchasing_SupplierTransactions] ON [Purchasing].[SupplierTransactions] ([TransactionDate])
GO
PRINT N'Creating primary key [PK_Purchasing_SupplierTransactions] on [Purchasing].[SupplierTransactions]'
GO
...
GO
PRINT N'Creating index [IX_Purchasing_SupplierTransactions_IsFinalized] on [Purchasing].[SupplierTransactions]'
GO
CREATE NONCLUSTERED INDEX [IX_Purchasing_SupplierTransactions_IsFinalized] ON [Purchasing].[SupplierTransactions] ([IsFinalized])
GO
PRINT N'Creating index [FK_Purchasing_SupplierTransactions_PaymentMethodID] on [Purchasing].[SupplierTransactions]'
GO
...
GO
PRINT N'Creating index [FK_Purchasing_SupplierTransactions_PurchaseOrderID] on [Purchasing].[SupplierTransactions]'
GO
...
GO
PRINT N'Creating index [FK_Purchasing_SupplierTransactions_SupplierID] on [Purchasing].[SupplierTransactions]'
GO
CREATE NONCLUSTERED INDEX [FK_Purchasing_SupplierTransactions_SupplierID] ON [Purchasing].[SupplierTransactions] ([SupplierID])
GO
PRINT N'Creating index [FK_Purchasing_SupplierTransactions_TransactionTypeID] on [Purchasing].[SupplierTransactions]'
GO
...
GO
PRINT N'Adding constraints to [Warehouse].[StockGroups]'
GO
...
GO
PRINT N'Creating primary key [PK_Application_SystemParameters] on [Application].[SystemParameters]'
GO
...
GO
PRINT N'Creating index [FK_Application_SystemParameters_DeliveryCityID] on [Application].[SystemParameters]'
GO
CREATE NONCLUSTERED INDEX [FK_Application_SystemParameters_DeliveryCityID] ON [Application].[SystemParameters] ([DeliveryCityID])
GO
PRINT N'Creating index [FK_Application_SystemParameters_PostalCityID] on [Application].[SystemParameters]'
GO
...
END;
GO
PRINT N'Adding constraints to [Sales].[Invoices]'
GO
...
GO
PRINT N'Adding constraints to [Sales].[SpecialDeals]'
GO
...
GO
PRINT N'Adding foreign keys to [Application].[SystemParameters]'
GO
...
GO
PRINT N'Adding foreign keys to [Purchasing].[Suppliers]'
GO
...
GO
PRINT N'Adding foreign keys to [Sales].[Customers]'
GO
...
GO
PRINT N'Adding foreign keys to [Application].[Cities]'
GO
...
GO
PRINT N'Adding foreign keys to [Application].[StateProvinces]'
GO
...
GO
PRINT N'Adding foreign keys to [Application].[Countries]'
GO
...
GO
PRINT N'Adding foreign keys to [Purchasing].[PurchaseOrders]'
GO
...
GO
PRINT N'Adding foreign keys to [Sales].[Invoices]'
GO
...
GO
PRINT N'Adding foreign keys to [Application].[DeliveryMethods]'
GO
...
GO
PRINT N'Adding foreign keys to [Purchasing].[SupplierTransactions]'
GO
...
GO
PRINT N'Adding foreign keys to [Sales].[CustomerTransactions]'
GO
...
GO
PRINT N'Adding foreign keys to [Application].[PaymentMethods]'
GO
...
GO
PRINT N'Adding foreign keys to [Application].[People]'
GO
...
GO
PRINT N'Adding foreign keys to [Application].[TransactionTypes]'
GO
...
GO
PRINT N'Adding foreign keys to [Purchasing].[PurchaseOrderLines]'
GO
...
GO
PRINT N'Adding foreign keys to [Purchasing].[SupplierCategories]'
GO
...
GO
PRINT N'Adding foreign keys to [Sales].[BuyingGroups]'
GO
...
GO
PRINT N'Adding foreign keys to [Sales].[CustomerCategories]'
GO
...
GO
PRINT N'Adding foreign keys to [Sales].[InvoiceLines]'
GO
...
GO
PRINT N'Adding foreign keys to [Sales].[OrderLines]'
GO
...
GO
PRINT N'Adding foreign keys to [Sales].[SpecialDeals]'
GO
...
GO
PRINT N'Adding foreign keys to [Warehouse].[Colors]'
GO
...
GO
PRINT N'Adding foreign keys to [Warehouse].[PackageTypes]'
GO
...
GO
PRINT N'Adding foreign keys to [Warehouse].[StockGroups]'
GO
...
GO
PRINT N'Adding foreign keys to [Warehouse].[StockItemHoldings]'
GO
...
GO
PRINT N'Adding foreign keys to [Warehouse].[StockItems]'
GO
...
GO
PRINT N'Adding foreign keys to [Warehouse].[StockItemStockGroups]'
GO
...
GO
PRINT N'Adding foreign keys to [Warehouse].[StockItemTransactions]'
GO
